...
!function() {
    var r = "object" == ("undefined" == typeof self ? "undefined" : n(self)) && self.self === self && self || "object" == ("undefined" == typeof global ? "undefined" : n(global)) && global.global === global && global || this || {}, t = r._, e = Array.prototype, u = Object.prototype, i = "undefined" != typeof Symbol ? Symbol.prototype : null, o = e.push, a = e.slice, c = u.toString, f = u.hasOwnProperty, l = Array.isArray, s = Object.keys, p = Object.create, h = function() {}, v = function n(r) {
        return r instanceof n ? r : this instanceof n ? void (this._wrapped = r) : new n(r);
    };
    "undefined" == typeof exports || exports.nodeType ? r._ = v : ("undefined" != typeof module && !module.nodeType && module.exports && (exports = module.exports = v), 
    exports._ = v), v.VERSION = "1.8.3";
    var y, d = function(n, r, t) {
        ...
        return v.iteratee !== y ? v.iteratee(n, r) : null == n ? v.identity : v.isFunction(n) ? d(n, r, t) : v.isObject(n) && !v.isArray(n) ? v.matcher(n) : v.property(n);
    };
    v.iteratee = y = function(n, r) {
        return g(n, r, 1 / 0);
    };
    var m = function(n, r) {
        ...
        return t ? n : void 0;
    }, _ = Math.pow(2, 53) - 1, A = j("length"), w = function(n) {
        var r = A(n);
        return "number" == typeof r && r >= 0 && r <= _;
    };
    v.each = v.forEach = function(n, r, t) {
        var e, u;
        if (r = d(r, t), w(n)) for (e = 0, u = n.length; e < u; e++) r(n[e], e, n); else {
            var i = v.keys(n);
        ...
        r = g(r, t);
        for (var e = !w(n) && v.keys(n), u = (e || n).length, i = Array(u), o = 0; o < u; o++) {
            var a = e ? e[o] : o;
            i[o] = r(n[a], a, n);
        }
        return i;
    ...
    var S = function(n) {
        return function(r, t, e, u) {
            ...
            return function(r, t, e, u) {
                var i = !w(r) && v.keys(r), o = (i || r).length, a = n > 0 ? 0 : o - 1;
    ...
    v.reduce = v.foldl = v.inject = S(1), v.reduceRight = v.foldr = S(-1), v.find = v.detect = function(n, r, t) {
        var e = (w(n) ? v.findIndex : v.findKey)(n, r, t);
        if (void 0 !== e && -1 !== e) return n[e];
    }, v.filter = v.select = function(n, r, t) {
        var e = [];
        return r = g(r, t), v.each(n, function(n, t, u) {
            r(n, t, u) && e.push(n);
        }), e;
    }, v.reject = function(n, r, t) {
        return v.filter(n, v.negate(g(r)), t);
    }, v.every = v.all = function(n, r, t) {
        r = g(r, t);
        for (var e = !w(n) && v.keys(n), u = (e || n).length, i = 0; i < u; i++) {
            var o = e ? e[i] : i;
        ...
        return w(n) || (n = v.values(n)), ("number" != typeof t || e) && (t = 0), v.indexOf(n, r, t) >= 0;
    }, v.invoke = m(function(n, r, t) {
        var e, u;
        return v.isFunction(r) ? u = r : v.isArray(r) && (e = r.slice(0, -1), r = r[r.length - 1]), 
        v.map(n, function(n) {
            var i = u;
            if (!i) {
    ...
    }, v.max = function(r, t, e) {
        var u, i, o = -1 / 0, a = -1 / 0;
        if (null == t || "number" == typeof t && "object" != n(r[0]) && null != r) for (var c = 0, f = (r = w(r) ? r : v.values(r)).length; c < f; c++) null != (u = r[c]) && u > o && (o = u); else t = g(t, e), 
        v.each(r, function(n, r, e) {
            ((i = t(n, r, e)) > a || i === -1 / 0 && o === -1 / 0) && (o = n, a = i);
        });
        return o;
    }, v.min = function(r, t, e) {
        var u, i, o = 1 / 0, a = 1 / 0;
        if (null == t || "number" == typeof t && "object" != n(r[0]) && null != r) for (var c = 0, f = (r = w(r) ? r : v.values(r)).length; c < f; c++) null != (u = r[c]) && u < o && (o = u); else t = g(t, e), 
        v.each(r, function(n, r, e) {
            ((i = t(n, r, e)) < a || i === 1 / 0 && o === 1 / 0) && (o = n, a = i);
        ...
        return v.sample(n, 1 / 0);
    }, v.sample = function(n, r, t) {
        if (null == r || t) return w(n) || (n = v.values(n)), n[v.random(n.length - 1)];
        var e = w(n) ? v.clone(n) : v.values(n), u = A(e);
        r = Math.max(Math.min(r, u), 0);
        for (var i = u - 1, o = 0; o < r; o++) {
            var a = v.random(o, i), c = e[o];
            e[o] = e[a], e[a] = c;
        }
        return e.slice(0, r);
    }, v.sortBy = function(n, r, t) {
        var e = 0;
        return r = g(r, t), v.pluck(v.map(n, function(n, t, u) {
            return {
                value: n,
                index: e++,
                criteria: r(n, t, u)
    ...
    var O = function(n, r) {
        return function(t, e, u) {
            var i = r ? [ [], [] ] : {};
            return e = g(e, u), v.each(t, function(r, u) {
                var o = e(r, u, t);
                n(i, r, o);
            }), i;
        };
    };
    v.groupBy = O(function(n, r, t) {
        v.has(n, t) ? n[t].push(r) : n[t] = [ r ];
    }), v.indexBy = O(function(n, r, t) {
        n[t] = r;
    }), v.countBy = O(function(n, r, t) {
        v.has(n, t) ? n[t]++ : n[t] = 1;
    });
    var k = /[^\ud800-\udfff]|[\ud800-\udbff][\udc00-\udfff]|[\ud800-\udfff]/g;
    v.toArray = function(n) {
        return n ? v.isArray(n) ? a.call(n) : v.isString(n) ? n.match(k) : w(n) ? v.map(n, v.identity) : v.values(n) : [];
    }, v.size = function(n) {
        return null == n ? 0 : w(n) ? n.length : v.keys(n).length;
    }, v.partition = O(function(n, r, t) {
        n[t ? 0 : 1].push(r);
    }, !0), v.first = v.head = v.take = function(n, r, t) {
        if (!(null == n || n.length < 1)) return null == r || t ? n[0] : v.initial(n, n.length - r);
    }, v.initial = function(n, r, t) {
        return a.call(n, 0, Math.max(0, n.length - (null == r || t ? 1 : r)));
    }, v.last = function(n, r, t) {
        if (!(null == n || n.length < 1)) return null == r || t ? n[n.length - 1] : v.rest(n, Math.max(0, n.length - r));
    }, v.rest = v.tail = v.drop = function(n, r, t) {
        return a.call(n, null == r || t ? 1 : r);
    }, v.compact = function(n) {
        return v.filter(n, Boolean);
    };
    var M = function n(r, t, e, u) {
        for (var i = (u = u || []).length, o = 0, a = A(r); o < a; o++) {
            var c = r[o];
            if (w(c) && (v.isArray(c) || v.isArguments(c))) if (t) for (var f = 0, l = c.length; f < l; ) u[i++] = c[f++]; else n(c, t, e, u), 
    ...
    v.flatten = function(n, r) {
        return M(n, r, !1);
    }, v.without = m(function(n, r) {
        return v.difference(n, r);
    }), v.uniq = v.unique = function(n, r, t, e) {
        v.isBoolean(r) || (e = t, t = r, r = !1), null != t && (t = g(t, e));
        ...
        return u;
    }, v.union = m(function(n) {
        return v.uniq(M(n, !0, !0));
    }), v.intersection = function(n) {
        for (var r = [], t = arguments.length, e = 0, u = A(n); e < u; e++) {
            var i = n[e];
            if (!v.contains(r, i)) {
                var o;
                for (o = 1; o < t && v.contains(arguments[o], i); o++) ;
                o === t && r.push(i);
            }
        }
        return r;
    }, v.difference = m(function(n, r) {
        return r = M(r, !0, !0), v.filter(n, function(n) {
            return !v.contains(r, n);
        });
    }), v.unzip = function(n) {
        for (var r = n && v.max(n, A).length || 0, t = Array(r), e = 0; e < r; e++) t[e] = v.pluck(n, e);
        return t;
    }, v.zip = m(v.unzip), v.object = function(n, r) {
    ...
    v.findIndex = F(1), v.findLastIndex = F(-1), v.sortedIndex = function(n, r, t, e) {
    ...
    var E = function(n, r, t) {
        return function(e, u, i) {
            var o = 0, c = A(e);
            if ("number" == typeof i) n > 0 ? o = i >= 0 ? i : Math.max(i + c, o) : c = i >= 0 ? Math.min(i + 1, c) : i + c + 1; else if (t && i && c) return e[i = t(e, u)] === u ? i : -1;
            if (u != u) return (i = r(a.call(e, o, c), v.isNaN)) >= 0 ? i + o : -1;
    ...
    v.bind = m(function(n, r, t) {
    ...
    })).placeholder = v, v.bindAll = m(function(n, r) {
        ...
        t || (t = {});
        var c = function() {
            a = !1 === t.leading ? 0 : v.now(), e = null, o = n.apply(u, i), e || (u = i = null);
        }, f = function() {
            var f = v.now();
            a || !1 !== t.leading || (a = f);
            var l = r - (f - a);
    ...
    }, v.once = v.partial(v.before, 2), v.restArgs = m;
    var I = !{
        toString: null
        ...
        var t = T.length, e = n.constructor, i = v.isFunction(e) && e.prototype || u, o = "constructor";
        for (v.has(n, o) && !v.contains(r, o) && r.push(o); t--; ) (o = T[t]) in n && n[o] !== i[o] && !v.contains(r, o) && r.push(o);
    };
    v.keys = function(n) {
        if (!v.isObject(n)) return [];
        if (s) return s(n);
        ...
        r = g(r, t);
        for (var e = v.keys(n), u = e.length, i = {}, o = 0; o < u; o++) {
            var a = e[o];
            i[a] = r(n[a], a, n);
        }
        return i;
    ...
    v.extend = R(v.allKeys), v.extendOwn = v.assign = R(v.keys), v.findKey = function(n, r, t) {
        r = g(r, t);
    ...
    v.pick = m(function(n, r) {
        var t = {}, e = r[0];
        if (null == n) return t;
        v.isFunction(e) ? (r.length > 1 && (e = d(e, r[1])), r = v.allKeys(n)) : (e = z, 
        ...
        return t;
    }), v.omit = m(function(n, r) {
        var t, e = r[0];
        return v.isFunction(e) ? (e = v.negate(e), r.length > 1 && (t = r[1])) : (r = v.map(M(r, !1, !1), String), 
        e = function(n, t) {
            return !v.contains(r, t);
        }), v.pick(n, e, t);
    }), v.defaults = R(v.allKeys, !0), v.create = function(n, r) {
        var t = b(n);
        ...
        return ("function" === i || "object" === i || "object" == (void 0 === t ? "undefined" : n(t))) && K(r, t, e, u);
    }, K = function(r, t, e, u) {
        r instanceof v && (r = r._wrapped), t instanceof v && (t = t._wrapped);
        var o = c.call(r);
        ...
        switch (o) {
          ...
          case "[object Symbol]":
            return i.valueOf.call(r) === i.valueOf.call(t);
        }
        var a = "[object Array]" === o;
        if (!a) {
            if ("object" != (void 0 === r ? "undefined" : n(r)) || "object" != (void 0 === t ? "undefined" : n(t))) return !1;
            var f = r.constructor, l = t.constructor;
            if (f !== l && !(v.isFunction(f) && f instanceof f && v.isFunction(l) && l instanceof l) && "constructor" in r && "constructor" in t) return !1;
        }
        e = e || [], u = u || [];
        for (var s = e.length; s--; ) if (e[s] === r) return u[s] === t;
        if (e.push(r), u.push(t), a) {
            if ((s = r.length) !== t.length) return !1;
            for (;s--; ) if (!q(r[s], t[s], e, u)) return !1;
        } else {
            var p, h = v.keys(r);
            if (s = h.length, v.keys(t).length !== s) return !1;
            for (;s--; ) if (p = h[s], !v.has(t, p) || !q(r[p], t[p], e, u)) return !1;
        }
        return e.pop(), u.pop(), !0;
    }, v.isEqual = function(n, r) {
        return q(n, r);
    }, v.isEmpty = function(n) {
        return null == n || (w(n) && (v.isArray(n) || v.isString(n) || v.isArguments(n)) ? 0 === n.length : 0 === v.keys(n).length);
    }, v.isElement = function(n) {
        return !(!n || 1 !== n.nodeType);
    }, v.isArray = l || function(n) {
        return "[object Array]" === c.call(n);
    }, v.isObject = function(r) {
        var t = void 0 === r ? "undefined" : n(r);
        return "function" === t || "object" === t && !!r;
    }, v.each([ "Arguments", "Function", "String", "Number", "Date", "RegExp", "Error", "Symbol", "Map", "WeakMap", "Set", "WeakSet" ], function(n) {
        v["is" + n] = function(r) {
    ...
    var D = r.document && r.document.childNodes;
    "function" != typeof /./ && "object" != ("undefined" == typeof Int8Array ? "undefined" : n(Int8Array)) && "function" != typeof D && (v.isFunction = function(n) {
        return "function" == typeof n || !1;
    }), v.isFinite = function(n) {
        return !v.isSymbol(n) && isFinite(n) && !isNaN(parseFloat(n));
    }, v.isNaN = function(n) {
        return v.isNumber(n) && isNaN(n);
        ...
        if (!v.isArray(r)) return null != n && f.call(n, r);
        for (var t = r.length, e = 0; e < t; e++) {
            var u = r[e];
    ...
    }, v.noop = function() {}, v.property = function(n) {
        return v.isArray(n) ? function(r) {
            return x(r, n);
        } : j(n);
    }, v.propertyOf = function(n) {
        return null == n ? function() {} : function(r) {
            return v.isArray(r) ? x(n, r) : n[r];
        };
    }, v.matcher = v.matches = function(n) {
        return n = v.extendOwn({}, n), function(r) {
    ...
    var L = {
        ...
        "'": "&#x27;",
        "`": "&#x60;"
    }, P = v.invert(L), W = function(n) {
        var r = function(r) {
            return n[r];
        }, t = "(?:" + v.keys(n).join("|") + ")", e = RegExp(t), u = RegExp(t, "g");
        return function(n) {
            return n = null == n ? "" : "" + n, e.test(n) ? n.replace(u, r) : n;
        };
    };
    v.escape = W(L), v.unescape = W(P), v.result = function(n, r, t) {
        v.isArray(r) || (r = [ r ]);
        var e = r.length;
        if (!e) return v.isFunction(t) ? t.call(n) : t;
        for (var u = 0; u < e; u++) {
            var i = null == n ? void 0 : n[r[u]];
            void 0 === i && (i = t, u = e), n = v.isFunction(i) ? i.call(n) : i;
        }
        return n;
    };
    var C = 0;
    ...
    v.template = function(n, r, t) {
        ...
        var e, u = RegExp([ (r.escape || J).source, (r.interpolate || J).source, (r.evaluate || J).source ].join("|") + "|$", "g"), i = 0, o = "__p+='";
    ...
    v.mixin = function(n) {
        return v.each(v.functions(n), function(r) {
            var t = v[r] = n[r];
            v.prototype[r] = function() {
                var n = [ this._wrapped ];
                return o.apply(n, arguments), G(this, t.apply(v, n));
            };
        }), v;
